...
Clicks and registrations that use the link count toward the campaign created for that email. See also [Mass Emails](/mass-emails#track-registrations-from-a-mass-email).
