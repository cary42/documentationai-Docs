...
- Families who try a spent-out or overshooting code see **Sorry. This discount is no longer available.** Staff who apply or raise a discount past the cap see a message that names the code, the maximum total, how much has been used, and what is left.
...
<ExpandableGroup>
  ...
  <Expandable title="Discount is not showing for families at checkout" default-open="false">
    ...
    - **Maximum Total** has budget left. If the dollar cap is spent out, or the next redemption would overshoot what is left, families see **Sorry. This discount is no longer available.**
