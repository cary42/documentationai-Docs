...
You can turn on Test Mode from **Forms** in the left navigation, then open the form and use the **TEST MODE** toggle in the form toolbar. You can also use the **Test Mode** toggle next to the availability chip on the **Form** step in **Guided setup**.
...
You can reach the toggle from the form editor or from Guided setup.
...
<Steps>
  ...
  In Campium, go to **Forms** in the left navigation.
...
<Steps>
  <Step title="Open Guided setup" icon="folder">

  Go to **Seasons**, then open **Guided setup** for the season. See [Guided Season Setup](/guided-season-setup).

  </Step>
  <Step title="Open the Form step" icon="edit">

  Move to the **Form** step and choose the form you want to preview.

  </Step>
  <Step title="Turn on Test Mode" icon="play-circle">

  Use the **Test Mode** toggle next to the form availability chip in the Form toolbar.

  The tooltip explains that when Test Mode is on, you can see the form on the portal regardless of start and end dates or recipients. While the form is already **Open**, the switch is locked off and the tooltip says it turned off automatically while the form is open.
...
<Steps>
  ...
  Go to **Forms**, open the form, and switch on **TEST MODE**. Or open **Guided setup**, go to the **Form** step, and switch on **Test Mode**.
...
While the form stays in that open window, you cannot turn Test Mode back on from Guided setup (the switch is locked). On the form editor, the **TEST MODE** tooltip also notes that Test Mode turns off automatically while the form is open.
