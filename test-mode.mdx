...
You can turn on Test Mode from **Forms** in the left navigation, then open the form and use the **Test Mode** toggle in the toolbar.
...
<Steps>
  ...
  Go to **Forms**, open the form, and switch on **Test Mode**.
