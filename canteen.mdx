...
- Choose how the purchase is paid:
  - **User account** — Charges the selected camper or staff canteen balance. Select the user first and confirm the account has enough money available.
...
- Families can see a separate balance for each relevant camper or user.
