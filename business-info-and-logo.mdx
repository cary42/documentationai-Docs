...
When your payment processor provides a dashboard link, **General Information** also shows **Merchant Site**.

When your camp processes payments with **USIO** or **Finix** and a merchant id is on file, you also see **Merchant ID** next to it.
