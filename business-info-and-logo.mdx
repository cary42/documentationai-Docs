...
<Steps>
  <Step title="Save before leaving the page" title-type="p">
...
<Callout kind="alert" collapsed="false">
  If you close your browser tab or navigate away before clicking **Save**, your new business details and logo will not be applied.
</Callout>
...
- Return to **Admin -> Business Info & Logo**.
