...
description: Create, schedule, and review mobile push notifications for your camp community using the Communications Push Notifications tool.
---
...
- Go to **Communication** in the main navigation.
...
<Step title="Open a new push notification" icon="play-circle">

- In the left navigation, select **Communication**.
...
<Step title="Fill out Settings" icon="edit">
...
<Step title="Review and send or schedule" icon="check-circle">
...
- Let your colleague know the draft is ready to review under **Communication → Push Notifications**.
