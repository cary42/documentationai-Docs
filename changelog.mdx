...
<Update label="2026-08-02" description="Balance Transfer labels on Negative Balance and Sales" tags={["improvement"]}>
  ...
  - **Balance Transfer UI labels** - On **Negative Balance** and the family **Sales** tab, the season-to-season move action is labeled **Transfer** / **Balance Transfer To Another Season**, with **Transfer Balance** to confirm. Ledger reasons use **Balance Transfer to** and **Balance Transfer from** the other season. See [Negative Balance](/negative-balance#transfer-a-credit-to-another-season).
</Update>
