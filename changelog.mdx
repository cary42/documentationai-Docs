...
<Update label="2026-07-31" description="Form response notes, email campaign tracking, season setup review, health report field management, photo auto-tagging, role-based field visibility, security hardening, and performance fixes" tags={["feature","improvement","security","bugfix"]}>
  ...
  - **Parent portal session security** — Social login handoffs (Google/Apple) now use single-use encrypted tokens, and portal identity links require encrypted tokens. See [Authentication](/authentication).
