...
<Update label="2026-06-01" description="Canteen cash withdrawals, My Groups for staff, DKIM email authentication, attendance improvements, and critical bug fixes" tags={["feature","improvement","security","bugfix"]}>
  ...
  - Added staff season management to user profiles, allowing admins to associate staff members with specific seasons from their profile page.
...
<Update label="2026-05-28" description="Canteen categories, bunk filters, admin redesign, future payment reliability, and cron fixes" tags={["feature","improvement","bugfix"]}>
  ...
  - Modularized bunking navigation for cleaner page organization.
  ...
  - Fixed save-client.php parse errors that could cause 500 errors on signup.
...
<Update label="2026-05-17" description="Rich text tickets, ACH void warnings, calendar improvements, volunteer type, payment nicknames, QuickBooks refunds, and encrypted portal tokens" tags={["feature","security","improvement","bugfix"]}>
  ...
  - Added scheduled smoke tests for login, invoice PDF, tax receipt PDF, and dashboard checks, including dev-environment validation before production deploys.
...
<Update label="2026-04-27" description="AI Chatbot, Terms of Service, IP blocking, email subscriptions, payment digests, QuickBooks sync, legal documents, and faster search" tags={["feature","security","improvement"]}>
  ...
  - Enhanced Fotomoto photo printing with improved widget data handling.
