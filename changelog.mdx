...
<Update label="2026-06-19" description="Parent account redesign, waitlist invite cancellation, balance transfer reporting, Finix fee visibility, payment safeguards, and admin fixes" tags={["feature","improvement","bugfix"]}>
  ...
  - Added a balance transfer utilization report to [Accounts Receivable](/account-balance) workflows, making it easier to review how transferred balances are being used.
