...
<Update label="2026-08-01" description="Mass-email Clicked and Registered stats, Balance Transfer payment type, and Revenue Summary transfer totals" tags={["feature","improvement"]}>
  ...
  - **Balance Transfer payment type** - Season-to-season credit and balance moves now appear as **Balance Transfer** in **Financials → Payments**. Filter with the **Balance Transfer** payment type checkbox. See [Payments](/payments) and [Negative Balance](/negative-balance#move-a-credit-to-another-season).
