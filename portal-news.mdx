...
description: Create and manage news posts that appear in the parent portal, including file links, YouTube videos, dates, and status controls.
---
...
Go to **Communication → News** in your Campium admin menu.
...
<Step title="Write the news content" icon="edit">

- In the **News** field, enter the full message you want families to read.
...
<Step title="Choose a news type" icon="settings">

- Locate the **News Type** dropdown.
- Choose **Parent Site News**, **Parent Site Files**, or **Youtube Video** based on what you are sharing.

The type you choose controls how parents interact with the news item in the portal.

</Step>

<Step title="Add any related file or link" icon="upload">

- If you selected **Parent Site Files**, use the **File** field to upload or attach the document parents need (for example, medical forms or schedules).
- If you selected **Youtube Video**, paste the YouTube embed URL into the provided field.
- If you selected **Parent Site News**, you usually do not need to attach a file, unless you want to include a downloadable document as part of the post.

</Step>

<Step title="Set start and end dates" icon="calendar">

- In **Start Date**, choose the date when the news should begin appearing in the parent portal.
...
<Step title="Choose the status and save" icon="check-circle">
...
Use **Parent Site News** for standard text announcements.

Parents click the item and read the content you wrote in the News editor, similar to a bulletin post.

#### Parent Site Files

Use **Parent Site Files** when the main purpose of the post is to share a file, such as:
...
Use **Youtube Video** to feature a YouTube video directly from the parent portal, such as:
...
From **Communication → News**, you can manage the list of existing items.

Each item includes actions that help you keep your portal organized over time.
...
## Tips for clear parent communication
