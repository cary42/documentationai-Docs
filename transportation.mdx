...
<Steps>
  ...
  <Step title="Set up buses for the season" icon="settings" titleType="p">
  ...
  <Step title="Add riders to a bus" icon="users" titleType="p">
  ...
  <Step title="Order riders by pickup or dropoff sequence" icon="list-ordered" titleType="p">
  ...
  <Step title="Add stop times and addresses (recommended)" icon="map" titleType="p">
  ...
  <Step title="Check riders in on bus day" icon="check-circle" titleType="p">
  ...
  The Riders page then reflects who is on the bus for that date.

  </Step>

  <Step title="View the map for live tracking" icon="monitor" titleType="p">
  ...
  When tracking is enabled, the map shows the bus location and updates periodically rather than instantly. Only buses with tracking enabled show as live on the map.

  </Step>

  <Step title="Email riders for a bus (optional)" icon="mail" titleType="p">
