...
On **Pickup Info**, use the **Guardians** table to mark a guardian **Allowed** or **Not allowed** for a camper. Blocked guardians do not appear at check-out. See [Block a guardian from picking up a camper](/attendance#block-a-guardian-from-picking-up-a-camper).
