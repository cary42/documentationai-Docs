...
## Chargebacks in Campium

Where a chargeback shows up in Campium depends on which processor your camp uses.

- **Finix** — A chargeback or dispute generates email alerts to your camp as it moves through its stages. You will receive an email at each stage as the case progresses: **INQUIRY**, **PENDING**, **LOST**, and **WON**. Watch your inbox so you can respond within the window while the case is still open.

- **Payabli** — Disputes appear in the **ACH Returns & Rejects** report. Check that report to find and track disputed transactions for your camp.

<Callout kind="info">

You will receive an email when a chargeback comes in, so you do not have to watch for one manually. Use the notification as your prompt to gather evidence and respond before the deadline.
