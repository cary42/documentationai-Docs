...
| **Field Type**    | Text, Date, Choose One, Choose Many, or Link to a User                    |
...
<ParamField body="Type" param-type="string" required="true" deprecated="false" show-location="false" enum="Choose One,Choose Many,Text,Date,Link to a User">
  Sets the answer format for the field. **Link to a User** connects the field to another person; when you pick it, choose the target user type the link points to (**Staff**, **Camper**, or **Guardian**).
</ParamField>
