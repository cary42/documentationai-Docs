...
- **Season** — Season or program group whose revenue you want to review. The report only includes sales tied to this selection.

- **Date Range** — Optional start and end dates that limit which sales are included, based on the **date the sale was recorded in Campium**.
...
- **Product** — Name or description of the product that was sold, such as "Week 1 Day Camp" or "Lunch Add-on".

- **Quantity** — Total number of units sold for the product during the selected filters (for example, camper enrollments or items).

- **Average Cost** — Average price paid per unit of the product, calculated from the sales included in the report.

- **Total Revenue** — Total revenue from this product for the selected season/program group and date range. This reflects the quantity sold multiplied by the average cost.
...
- **Payment Type** — Category of payment, such as **Credit Card**, **Cash**, **Check**, **ACH**, **Refund**, **Void**, or **Adjustment**.

- **Amount** — Total amount for that payment type within the selected filters. Positive values usually indicate money received; negative values indicate money returned or reversed.
...
- **Discount** — Name or description of the discount applied, such as "Sibling Discount" or "Early Registration".

- **Quantity** — Number of times this discount was applied in the selected period.

- **Amount** — Total value of the discount across all uses. Higher amounts indicate a greater reduction to gross revenue.
