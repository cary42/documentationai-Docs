...
<ParamField body="Group revenue by profile field" param-type="selector" required="false" deprecated="false">
  Optional profile field used to break down revenue by each answer to that field. When you choose a field, the report adds a **Revenue by {field}** table at the top showing registrations and total revenue for each answer value. Leave it unset to skip the breakdown.
</ParamField>
...
When you choose a field in **Group revenue by profile field**, the report adds a **Revenue by {field}** table at the top, above the Products, Payments, and Discounts sections. The heading uses the field you selected, so grouping by grade shows a **Revenue by Grade** table.
...
<ParamField body="Total Revenue" param-type="currency" required="true" deprecated="false">
  Total revenue attributed to registrations with this field value.
</ParamField>
