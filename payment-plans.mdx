...
- At checkout, families see **Charge day of the month** with days from the **1st** to the **28th**, plus helper text: **Your payments will run on this day each month. You will not be able to change it after you check out.**
