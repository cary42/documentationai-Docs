...
description: >-
  Use One-way Messaging to send a single, targeted email to families, with
  subject, sender, schedule, recipients, and basic delivery logs.
---
...
<Steps>
  <Step title="Go to Communications" icon="folder" title-type="p">
  ...
  <Step title="Open One-way Messaging" icon="arrow-right" title-type="p">
...
<Steps>
  <Step title="Set up email details (Settings tab)" icon="settings" title-type="p">
    - Enter a **Name of Email** so you can recognize this message later in your list.

    - Fill in **From Email Address** using an allowed sender address for your camp.
  ...
  <Step title="Add attachments (optional)" icon="upload" title-type="p">
  ...
  <Step title="Choose when to send" icon="clock" title-type="p">
  ...
  <Step title="Preview and test" icon="info" title-type="p">
  ...
  <Step title="Send the email" icon="play-circle" title-type="p">
...
When the email sends successfully, you will see status information such as **Sent:&#x20;**&#x20;and basic delivery and open information in the Logs area.
...
<Tabs>
  <Tab title="Settings" icon="settings">
    ...
    - **From Email Address (must be&#x20;****)**: The sender address families see. This must match an allowed domain for your camp.

    - **Subject**: The subject line that appears in the recipient's inbox.

    - **Merge Variables:&#x20;****&#x20;****&#x20;**: Short codes you insert into the subject or body to personalize each email with the recipient's details.
  ...
  <Tab title="Logs" icon="bar-chart">
    ...
    - **Sent:&#x20;**: Displays the time the email was sent.
