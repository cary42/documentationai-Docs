...
- **Description**  
  Text shown on the portal next to this option (column tip **Displayed on portal site only**). Click to edit inline (**Edit description**). Empty values show **None set**. Use friendly wording for families.
