...
Each integration card shows **Connected** or **Not connected** so you can see status at a glance. Open **Configure** to set up, test, or disconnect.
...
On each integration’s settings page, use **Disconnect** when you want to clear the connection.

1. On **Admin > Integrations**, click **Configure** for the service.
2. Click **Disconnect** and confirm the prompt.
3. Confirm that the Integrations list shows **Not connected** for that service.

Confirm text by service:

- Mailchimp: **Disconnect Mailchimp? Your API key and selected audience will be cleared.**
- Klaviyo: **Disconnect Klaviyo? Your API key and selected list will be cleared.**
- Slack: **Disconnect Slack? Your webhook URL will be cleared.**
- Constant Contact: **Disconnect Constant Contact?**
- Salesforce: **Disconnect Salesforce?**
- QuickBooks: confirms that you want to disconnect QuickBooks.

You can reconnect later by entering credentials again or signing in again.
...
If QuickBooks stops accepting syncs (for example an ended QuickBooks subscription or an expired connection), staff see a banner: **QuickBooks is not accepting syncs. Renew your QuickBooks subscription if it has ended, or reconnect below. Campium will keep retrying.** Campium also emails your **Contact Email Address** with subject **QuickBooks is not accepting syncs** and a button **Open QuickBooks connection**. Reconnect from **Admin → Integrations → Configure** next to QuickBooks, or renew the subscription if that is the cause.
