...
Open instances from a template row (**View instances**) or go to the Contract Instances page for that template. The instances table includes a **Filter** search box and defaults to showing 300 rows.
