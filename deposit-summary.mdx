...
description: >-
  Use the Deposit Summary in Campium to review new and batched deposits,
  understand fees and net totals, filter by date, create deposits, and export or
  print.
---
## Overview
...
<ParamField query="Start date" param-type="date" required="false" deprecated="false">
...
<ParamField query="End date" param-type="date" required="false" deprecated="false">
...
<ParamField body="Select" param-type="boolean" required="false" deprecated="false">
...
<ParamField body="Date Entered" param-type="datetime" required="false" deprecated="false">
...
<ParamField body="Total" param-type="number" required="false" deprecated="false">
  The amount of the individual payment, shown as a currency value.
</ParamField>

<ParamField body="Total (footer)" param-type="number" required="false" deprecated="false">
...
<ParamField body="Batch Number" param-type="string" required="false" deprecated="false">
  The deposit batch number. Click this link to open a detailed view of the payments included in that deposit.
</ParamField>

<ParamField body="Number of Items" param-type="integer" required="false" deprecated="false">
...
<ParamField body="Fees" param-type="number" required="false" deprecated="false">
...
<ParamField body="Net" param-type="number" required="false" deprecated="false">
...
<ParamField body="Grand totals (footer)" param-type="object" required="false" deprecated="false">
