...
<Callout kind="info" collapsed="false">
  Staff can use this page only if their login includes the **Bunking** permission for the bunking module. If you see an access message instead of the board, ask an administrator to confirm you have the Bunking permission.
</Callout>
...
Once campers are placed, two related tools help you print and review your bunks.
