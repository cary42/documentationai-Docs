...
5. When a section field is set, a **Division Colors** style card appears (the heading uses your section field's name). Pick a color per option and click **Save Division Colors** (or **Save Village Colors**, matching the field name). Those colors appear on Bunk Summary.
