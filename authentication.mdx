...
description: >-
  ...
  application, and handles Google and Apple sign-in, plus admin-focused
...
<Callout kind="info" collapsed="false">
  Password reset links expire after 24 hours and work only once. Stronger, application-specific password rules apply across all flows, and Google and Apple sign-in are available on the login page.
</Callout>
...
<Steps>
  <Step title="Open account settings" icon="settings" title-type="p">
  ...
  <Step title="Enter and confirm new password" icon="shield" title-type="p">
  ...
  <Step title="Re-authenticate if prompted" icon="check-circle" title-type="p">
