...
The day before a form’s **Start Date**, Campium emails a **Form opening** digest to users with the **Administrator** role. The subject looks like **{Form name} opens tomorrow** (or **{N} forms open tomorrow** when more than one form opens that day).
...
Use those notes to fix **Visibility**, clear a test form flag, or add products before families expect the form. There is no separate toggle for this email. It is not controlled by **Settings → Email Notifications**.
