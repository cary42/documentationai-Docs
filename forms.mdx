...
Administrators control this digest under **Settings → Email Notifications** as **Form opening digest** (toggle **Email me this digest**). It defaults on unless you turn it off. Organization-wide on/off lives on **Admin → Email Notifications**. See [Account](/account#email-notifications).
