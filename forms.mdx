...
- Includes a bottom sticky action bar with **Auto-Save** and **Save Settings**. The bar stays visible while you scroll the **Settings** tab.
...
On the **Settings** tab, **Save Settings** and the **Auto-Save** switch sit in a sticky bar at the bottom of the form. The bar stays in view while you scroll. **Auto-Save** applies only to your account, not everyone at your organization.
