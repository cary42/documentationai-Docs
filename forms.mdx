...
If your workflow collects references as part of an application, you can link up to two other forms as references.

#### Reference One Form and Reference Two Form

**Reference One Form** and **Reference Two Form** let you attach existing forms that serve as references for this form. Select the form you want to use in each field.

Use these when an application needs supporting forms completed by someone other than the primary applicant, such as a recommendation or reference questionnaire. Leave a field empty if you do not need that reference.
