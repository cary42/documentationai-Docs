...
title: Photo Hosting
description: >-
  Use Photo Hosting and the Gallery Module in CampiumDB to upload, tag, and
  share camp photos with families, including reports and facial recognition.
---
## Overview
...
<Steps>
  <Step title="Turn on Photo Hosting and the Gallery Module" icon="settings" title-type="p">
