...
<Image src="/images/payment-issues-card.png" width="1868" height="750" alt="The Payment Issues card on the CampiumDB home dashboard, showing shortcut links to Card Updates, Payment Plans, Scheduled Payments, Scheduled Payments Potential Issues, No Primary Payment Method, Scheduled Payment Email Log, Scheduled Payments - Missing, and ACH Returns and Rejects, with red count badges and the payment digest checkbox at the bottom." caption="The Payment Issues card on the home dashboard" />
