...
description: >-
  Monitor billing health from the CampiumDB dashboard with payment issue
  shortcuts, badge counts, ACH visibility, and payment digest controls.
---
## Overview
...
<Steps>
  <Step title="Open the home dashboard" icon="home" title-type="p">
    - Sign in to CampiumDB.
    - Go to the home dashboard.
  </Step>

  <Step title="Look for the Payment Issues card" icon="bar-chart" title-type="p">
...
<Image src="https://blob-cdn.documentation.ai/org-0d8eec32-96fa-419f-9505-03b1e136b066/doc-76bb5730-4569-4c2d-926d-aa8a7b125b49/1786467755259-u5wghh2pd3o-payment-issues-card.png?fm=auto&auto=compress%2Cformat" width="1868" height="750" alt="" />
