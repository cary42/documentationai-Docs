...
<Callout kind="info" collapsed="false">
  The bottom row totals each column across every season shown, giving you a single view of campers, revenue, discounts, payments, and receivables for the period. When the sum of **Number of Campers** across seasons is higher than the count of distinct people (someone appears in more than one season), the camper total also shows a unique count such as **42 unique campers**.
</Callout>
