...
When Special Weeks is enabled and the `weeks` field has options, families can pick weeks on the registration products step. They see the heading **Which weeks will you attend?** with the help text **Select every week that applies.**, then a checkbox for each week option.
