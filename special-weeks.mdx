...
The summary looks like **N sessions ask for more weeks than families can pick. Only X weeks have dates for this season…** (or **No special week has dates for this season yet…**). Listed sessions read **Session name asks for N weeks.** Use **Set special week dates** to open the Special Weeks calendar, or lower **Number of Weeks** on the session. Families cannot finish registration for a mismatched session until you fix it.
