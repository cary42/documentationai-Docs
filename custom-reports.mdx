...
<Steps>
  ...
  <Step title="Confirm access settings" icon="lock" title-type="p">
    - Review whether the report is shared with **Everyone** or limited to **Just Me**.

    - Update access if you are ready to share it with other admins.
  </Step>
</Steps>

<Callout kind="info" collapsed="false">
  Save often when building a more complex report. Saving updates the configuration so you do not lose your work if you navigate away or step away from your session.
</Callout>
