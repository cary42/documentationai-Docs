...
Every column header in the results table is a sort control. Select a header once to sort that column A to Z (or lowest to highest), and select it again to flip to Z to A. The arrow in the header shows the current direction. For example, to list campers alphabetically by last name, select the **Last Name** header.

If the column you want to sort by is not in the table, add it under **Choose display fields**, save, and run the report again.
