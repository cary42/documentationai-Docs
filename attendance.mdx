...
| Someone was marked absent, then they arrive | On the live roster, **Check-in** stays disabled while the row shows **Absent**. Click **undo** next to **Absent**, then **Check-in**. On the [Attendance Kiosk](/system-report-attendance-kiosk), a successful **Check-in** scan clears the **Absent** flag for that day automatically. |
