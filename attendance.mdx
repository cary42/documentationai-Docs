...
When **Pickup Module** is enabled, families see **Pickup privileges** for each camper in the parent portal.
...
If you turn off pickup for a guardian on that camper (see below), that guardian sees: **Pickup contacts for this camper are managed by the camp. Contact the camp to make changes.** Nobody can add a pickup contact whose name matches a blocked guardian; the portal shows: **This person can't be added as a pickup contact. Contact the camp for help.**
...
1. Under **Guardians**, find the camper and guardian row. Helper text: **Turn off pickup for a guardian who may not collect a camper. They won't be offered at check-out on the web, app, or kiosk.**
...
3. Confirm with **Yes, stop pickup** when turning pickup off. Staff without edit permission see **Allowed** / **Not allowed** badges instead of the switch.

Under **Authorized Pickups**, a contact whose name matches a blocked guardian shows the badge **Hidden at check-out**. Check-out refuses that person with: **This guardian is not allowed to pick up this camper.**
