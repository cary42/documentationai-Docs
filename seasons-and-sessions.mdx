...
<Steps>
  ...
  <Step title="Fill in copy fields" icon="edit" title-type="p">
    ...
    <ParamField body="New Season End Date" param-type="date" required="true" deprecated="false">
      The end date for the new Season. It follows the **Move Dates** option you picked. Change it if this season should end on a different date. Helper text: **Follows the option above. Change it if this season ends on a different date.**
    </ParamField>
  </Step>
...
<Steps>
  ...
  <Step title="Configure schedule and stats fields" icon="bar-chart" title-type="p">
    ...
    <ParamField body="Days of Week" param-type="array" required="false" deprecated="false">
      Multi-select dropdown labeled `Days of Week`. It appears only after you enable the **Schedule** dates below. Use it to pick which days of the week this Session runs.
    </ParamField>
    ...
    <ParamField body="Start Date" param-type="date" required="false" deprecated="false">
      Labeled `Start Date` under the **Schedule** heading. Set the day this Session begins. Enabling the schedule dates reveals the **Days of Week** dropdown above.
    </ParamField>

    <ParamField body="End Date" param-type="date" required="false" deprecated="false">
      Labeled `End Date` under the **Schedule** heading. Use it with the start date to define the Session's date range.
    </ParamField>
...
Subproducts/options let you offer one Session in different ways — by grade, age band, time slot, or another profile answer — each with its own price, deposit, capacity, wait list, and status. Add one with the **New Subproduct** button, and adjust the `Price`, `Min. Dep.`, and `Capacity` columns inline directly in the options list, or open the edit modal for name, description, staff, and status changes.
