...
<Steps>
  ...
  <Step title="Fill in copy fields" icon="edit" title-type="p">
    ...
    <ParamField body="New Season End Date" param-type="date" required="true" deprecated="false">
      The end date for the new Season. Set this to the date the copied Season should run through.
    </ParamField>

    <ParamField body="Increase Form and Payment Plan dates by one year" param-type="boolean" required="false" deprecated="false">
      Checkbox that is **checked by default**. Leave it checked to shift the copied forms' and payment plans' dates forward by one year, which is what you usually want when reusing last year's setup for a new Season. Uncheck it to copy those dates unchanged.
    </ParamField>
  </Step>
