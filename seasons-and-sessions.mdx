...
<Steps>
  <Step title="Sign in to the staff admin website" icon="lock" title-type="p">
  ...
  <Step title="Open the products or sessions page for the Season" icon="folder" title-type="p">
  ...
  <Step title="Find the Cancellation Fees button" icon="settings" title-type="p">
  ...
  <Step title="Expand the panel" icon="chevron-right" title-type="p">
...
<Steps>
  <Step title="Enter the fee name" icon="edit" title-type="p">
  ...
  <Step title="Enter the amount" icon="bar-chart" title-type="p">
  ...
  <Step title="Add the description" icon="book-open" title-type="p">
  ...
  <Step title="Create the cancellation fee" icon="check-circle" title-type="p">
...
<Steps>
  <Step title="Find the cancellation fee row" icon="folder" title-type="p">
  ...
  <Step title="Select Edit" icon="edit" title-type="p">
  ...
  <Step title="Update the fields" icon="settings" title-type="p">
  ...
  <Step title="Save the changes" icon="check-circle" title-type="p">
...
<Steps>
  <Step title="Select Delete" icon="trash" title-type="p">
  ...
  <Step title="Confirm the deletion" icon="alert-triangle" title-type="p">
...
<ExpandableGroup>
  <Expandable title="Name is required" default-open="false">

    Add a name before you select **Create Cancellation Fee** or **Update Cancellation Fee Session**. Use a short label that staff can identify later in the fee list.

  </Expandable>

  <Expandable title="Amount must be greater than 0" default-open="false">

    Enter a positive amount for the cancellation fee. Check that the amount field does not contain `0`, a blank value, or non-numeric characters.

  </Expandable>

  <Expandable title="Description is required" default-open="false">

    Add a description before saving. Use the description to explain when staff should apply this cancellation fee.

  </Expandable>

  <Expandable title="Session name already exists in this season" default-open="false">

    Choose a different name. Cancellation fees create dedicated sessions inside the Season, so the name must be unique within that Season.

  </Expandable>

  <Expandable title="Delete button does not work" default-open="false">

    The fee may already be tied to registrations, which blocks deletion. Keep the existing fee for historical use and create a new one for future cancellations.
