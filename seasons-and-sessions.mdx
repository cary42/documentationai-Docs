...
<Steps>
  ...
  <Step title="Start the copy" icon="play-circle" title-type="p">
    ...
    Still open the registration form’s layout tab (labeled **Sessions Layout**, **Products Layout**, or similar based on your site wording) after a copy and confirm every session families should see is in the right group. Sessions left in the holding area do not appear on the form for families.
  </Step>
</Steps>
